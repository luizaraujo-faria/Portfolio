...
const MenuBar = ({ scrolled, className }) => {
  ...
  return (
    <aside className={`w-full h-screen transition-all duration-300 fixed z-40 left-0 top-0 bg-black flex items-center justify-center flex-col gap-16 p-2 md:w-2/4 lg:w-2/6 dark:bg-white ${className}`}>
