...
const ContactSection = () => {
    ...
    return <section id='contact' className="w-full h-screen bg-black relative z-20 flex items-center justify-start flex-col gap-16 lg:h-[115vh] dark:bg-white">
